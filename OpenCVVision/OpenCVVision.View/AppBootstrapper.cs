    ...
    */
    ...
    public class AppBootstrapper : ReactiveObject, IScreen, IEnableLogger
    {
        ...
        private void LoadDlls()
        {
            ...
            List<string> dlls = Directory.GetFiles(starupPath).Where(f => f.Contains(".dll")).Select(f => f.Replace(starupPath + @"\", "")).Where(n => n.Contains("OpenCVVision")).ToList();
